...
const mHeightSpan = SizedBox(height: 10);
const lHeightSpan = SizedBox(height: 20);
const elHeightSpan = SizedBox(height: 40);
...
const lAllPadding = EdgeInsets.all(10);
...
const buttonRightPadding = EdgeInsets.only(left: 260);

//margin

const landingMargin = EdgeInsets.all(24.0);
const landingDotMrgin = EdgeInsets.all(2.0);

//loginform padding

const textFormPadding = EdgeInsets.only(left: 20, right: 20);
